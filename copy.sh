...
rm "$PUPPET_ENV_DIR/deploylamp/modules/database/templates/*"
...
rm "$PUPPET_ENV_DIR/nginx/modules/example_web/manifests/*"
mkdir -p "$PUPPET_ENV_DIR/nginx/modules/example_web/templates"
rm "$PUPPET_ENV_DIR/nginx/modules/example_web/templates/*"
...
rm "$PUPPET_ENV_DIR/requisites/modules/requisites/manifests/*"
